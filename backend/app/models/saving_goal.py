...
from sqlalchemy import String, Date, Numeric, Text, Boolean, ForeignKey, text
...
class SavingGoal(Base, TimestampMixin, SoftDeleteMixin):
    ...
    current_amount: Mapped[Decimal] = mapped_column(Numeric(15, 2), server_default="0", nullable=False)
