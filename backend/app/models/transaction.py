...
from sqlalchemy import String, Date, Numeric, Text, ForeignKey, Enum as SAEnum
...
class Transaction(Base, TimestampMixin, SoftDeleteMixin):
    ...
    recurring_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("recurring_rules.id", ondelete="SET NULL"), nullable=True)
