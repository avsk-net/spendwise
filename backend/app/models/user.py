...
class User(Base):
    ...
    created_at: Mapped[datetime.datetime] = mapped_column(server_default=text("NOW()"), nullable=False)
    ...
    saving_goals: Mapped[list["SavingGoal"]] = relationship(back_populates="user", cascade="all, delete-orphan")
